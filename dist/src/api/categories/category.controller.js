...
let CategoryController = class CategoryController extends handler_1.default {
    async getAllCategories(_req, res) {
        const allCategories = await this
            .TryCatch(() => category_service_1.default.getAllCategories());
        return res.status(enumStatusCodes_1.default.OK).json(allCategories);
    }
};
__decorate([
    (0, express_1.Get)(''),
...
CategoryController = __decorate([
    (0, express_1.Controller)('/categories')
], CategoryController);
